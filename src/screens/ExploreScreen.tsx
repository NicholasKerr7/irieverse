          ...
          <div className="p-4 sm:p-6">
              ...
              <div className="inline-flex rounded-full border border-slate-700/80 bg-slate-950/80 p-1 text-xs">
                <button
                  ...
                  className={classNames(
                    "flex min-h-10 items-center gap-2 rounded-full px-4 font-semibold transition",
            ...
            <div className="mt-4 space-y-3">
              <div className="flex gap-2 overflow-x-auto pb-1">
                {VIBE_OPTIONS.map((option) => (
                  <button
                    ...
                    className={classNames(
                      "min-h-10 whitespace-nowrap rounded-full border px-3 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.14em] transition",
                      app.vibe === option.id
              ...
              <div className="flex flex-wrap gap-2">
                {app.viewMode === "experiences" &&
                  EXPERIENCE_TYPES.map((option) => (
                    <button
                      ...
                      className={classNames(
                        "min-h-10 rounded-full border px-3 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.14em]",
                ...
                {app.viewMode === "places" && (
                  <label className="flex min-h-10 items-center gap-2 rounded-full border border-slate-700/80 bg-slate-950/60 px-3 py-2 text-[0.68rem] font-semibold uppercase tracking-[0.14em] text-slate-300">
