  ...
  MBJ: [
    {
      ...
      rating: 4.7,
      perks: ["Fallback data", "Breakfast included", "Rooftop plunge pool"],
    },
    {
      ...
      perks: ["Fallback data", "2 checked bags"],
    },
  ],
  KIN: [
    {
      ...
      rating: 4.5,
      perks: ["Fallback data", "Studio drop-in", "Night market shuttle"],
    },
  ],
};
